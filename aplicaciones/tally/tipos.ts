...
export type TwitterBasicos = {
  ...
  author_id: String;
  author_name: String; // Modelado de "includes"
  author_username: String; // Modelado de "includes"
  ...
  geo: {
    ...
    place_id: String;
    place_full_name: String; // Modelado de "includes"
  };
